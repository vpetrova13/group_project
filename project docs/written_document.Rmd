...
Our dashboard contains the visualisation of the annual number of inpatient stays in hospitals for the last 10 years in Scotland which can be further splitted by gender,
sex and specialty.
